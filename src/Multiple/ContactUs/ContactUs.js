...
//           <div className="relative z-10 mt-[-120px] w-full px-2">
//             <div className="bg-[#18254F] text-white rounded-xl shadow-xl p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
//               <div className="flex items-center gap-4">
//                 <div className="bg-white text-pink-600 p-3 rounded-full text-xl">📞</div>
//                 <div>
...
//                   <p className="text-sm">427 Hall Place Longview</p>
//                 </div>
//               </div>
//               <div className="flex items-center gap-4">
//                 <div className="bg-white text-pink-600 p-3 rounded-full text-xl">⏰</div>
//                 <div>
//                   <p className="font-semibold">Office Time</p>
//                   <p className="text-sm">10AM - 10PM</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           {/* Top Button */}
//           <button className="mb-4 bg-[#EF2E73]  text-white  py-2 px-4 rounded-full">
//             Send us email
//           </button>
//           <h2 className="text-3xl font-bold mb-6">Feel Free to write</h2>

//           <form className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
//             <input type="text" placeholder="Enter Name" className="border border-gray-300 rounded-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-pink-400" />
//             <input type="email" placeholder="Enter Email" className="border border-gray-300 rounded-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-pink-400" />
//             <input type="text" placeholder="Enter Subject" className="border border-gray-300 rounded-md p-3 w-full md:col-span-1 focus:outline-none focus:ring-2 focus:ring-pink-400" />
//             <input type="tel" placeholder="Enter Phone" className="border border-gray-300 rounded-md p-3 w-full md:col-span-1 focus:outline-none focus:ring-2 focus:ring-pink-400" />
//             <textarea placeholder="Enter Message" className="border border-gray-300 rounded-md p-3 w-full md:col-span-2 h-32 resize-none focus:outline-none focus:ring-2 focus:ring-pink-400"></textarea>
//             <button
//               type="submit"
